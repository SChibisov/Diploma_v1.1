...
UPDATE_PRODUCT = text("""UPDATE public.products 
                                      ...
                                      WHERE id=:id""")
UPDATE_PRODUCT_COUNT = text(
    "UPDATE public.products SET product_cnt=:product_cnt, is_available=:is_available WHERE id=:id")
...
class CartRepository:
    @staticmethod
    def get_cart_by_user_id(user_id: int) -> List[Cart]:
        user_carts: List[Cart] = []
